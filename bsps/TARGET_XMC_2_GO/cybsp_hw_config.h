/***********************************************************************************************/ /**
                                                                                                   ...
                                                                                                   *
                                                                                                   * \brief
                                                                                                   * Basic API for handling defaults for hardware so code
                                                                                                   *examples behave the same across different devices.
                                                                                                   *
                                                                                                   ***************************************************************************************************
                                                                                                   * \copyright
                                                                                                   * Copyright 2018-2022 Cypress Semiconductor Corporation (an
                                                                                                   *Infineon company) or an affiliate of Cypress Semiconductor
                                                                                                   *Corporation
                                                                                                   *
